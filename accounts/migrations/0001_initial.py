    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('height', models.CharField(help_text='in metres', max_length=8, null=True, verbose_name='height')),
                ('weight', models.CharField(help_text='in kgs', max_length=8, null=True, verbose_name='weight')),
                ...
                ('mobile_country_code', models.CharField(max_length=3, null=True, verbose_name='code')),
                ('mobile_phone_number', models.CharField(max_length=9, null=True, verbose_name='number')),
                ('stripe_id', models.CharField(max_length=32, verbose_name='stripe')),
